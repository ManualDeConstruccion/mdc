    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='water_certificate', to='properties.property')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='certificates/', verbose_name='Archivo de Certificado')),
                ('certificate_comment', models.CharField(blank=True, max_length=255, null=True, verbose_name='Comentario de Certificado')),
                ('county_recorder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='properties.countyrecorder', verbose_name='county_recorder')),
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ownership_certificate', to='properties.property')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='certificates/', verbose_name='Archivo de Certificado')),
                ('certificate_comment', models.CharField(blank=True, max_length=255, null=True, verbose_name='Comentario de Certificado')),
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gas_certificate', to='properties.property')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='certificates/', verbose_name='Archivo de Certificado')),
                ('certificate_comment', models.CharField(blank=True, max_length=255, null=True, verbose_name='Comentario de Certificado')),
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='electric_certificate', to='properties.property')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('building_permit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='properties.buildingpermit', verbose_name='Permiso de Construcción')),
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bulding_reception', to='properties.property')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='property',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='building_permit', to='properties.property'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='certificates/', verbose_name='Archivo de Certificado')),
                ('certificate_comment', models.CharField(blank=True, max_length=255, null=True, verbose_name='Comentario de Certificado')),
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='other_certificate', to='properties.property')),
            ],
            options={
